...
#img1 = DeepFace.detectFace("C:\\development\\surveilance\\code\\deepface\\img\\image.jpg")
...
def register(face_detector,model,input_shape,frame,detections):
    ...
    cv2.imwrite("C:\\development\\surveilance\\code\\deepface\\img\\image_registered.jpg", frame)
